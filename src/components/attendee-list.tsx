import { Search, MoreHorizontal, ChevronsLeft, ChevronLeft, ChevronRight, ChevronsRight, SpaceIcon } from 'lucide-react'
                    ...
                    {attendees.map((attendee) => {return(
                        <TableRow key={attendee.id}>
                            ...
                            <TableCell>
                                ...
                                ? <span className='text-zinc-400'>no check-in</span> 
